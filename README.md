...
- Single Prefix Bot :).
- New plugin system to less lag on server

[![GitHub repo size](https://img.shields.io/github/repo-size/Eximinati/Ari-Ani?style=flat-square)](https://github.com/Eximinati/Ari-Ani)
